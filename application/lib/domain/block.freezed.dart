...
abstract class $BlockCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic id, String fingerprint, List<Transaction> transactions});
}
...
class _$_Block implements _Block {
  ...
  @override
  String toString() {
    return 'Block(id: $id, fingerprint: $fingerprint, transactions: $transactions)';
  }
...
abstract class $TransactionCopyWith<$Res> {
  ...
  @useResult
  $Res call({int type, String timestamp});
}
...
class _$_Transaction implements _Transaction {
  const _$_Transaction({required this.type, required this.timestamp});
...
abstract class _Transaction implements Transaction {
  const factory _Transaction(
      ...
      required final String timestamp}) = _$_Transaction;
